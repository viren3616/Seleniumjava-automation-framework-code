...
public class Intelli365ContactUs {
	...
	public static void main(String[] args) {
	    ...
	    driver.findElement(By.xpath("//input[@name='your-name']")).sendKeys("Robert John");
	    
	    // Send correct EmailID to Name Your Email TextBox
	    // System.out.println("Send correct Email to Email TextBox");
	    driver.findElement(By.xpath("//input[@name='your-email']")).sendKeys("robert@gmail.com");
	    
	    String ExpectedMassage = "Thank you for your message. It has been sent.";
	    // System.out.println("Thank you for your message. It has been sent.");
	    driver.findElement(By.xpath("//input[@value='Send']")).click();
	    
	    String ActualMassage = "Thank you for your message. It has been sent.";
	    
	    System.out.println("Thank you for your message. It has been sent : "+ActualMassage);
